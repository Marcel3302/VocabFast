...
export const languages: Language[] = [
  ...
  { code: 'sl', name: 'Slowenisch', nativeName: 'Slovenščina', symbol: 'SL', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2'] },
  ...
  { code: 'nl', name: 'Niederländisch', nativeName: 'Nederlands', symbol: 'NL', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1','C2'] },
  { code: 'pl', name: 'Polnisch', nativeName: 'Polski', symbol: 'PL', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1'] },
  { code: 'cs', name: 'Tschechisch', nativeName: 'Čeština', symbol: 'CS', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1'] },
  { code: 'tr', name: 'Türkisch', nativeName: 'Türkçe', symbol: 'TR', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1'] },
  { code: 'el', name: 'Griechisch', nativeName: 'Ελληνικά', symbol: 'EL', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1'] },
  { code: 'ru', name: 'Russisch', nativeName: 'Русский', symbol: 'RU', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1'] },
  { code: 'uk', name: 'Ukrainisch', nativeName: 'Українська', symbol: 'UK', available: true, courseAvailable: false, translationAvailable: true, levels: ['A1','A2','B1','B2','C1'] },
...
export const learningUnits: LearningUnit[] = [
  { id: 1, title: 'Erste Gespräche', subtitle: 'Begrüßen, vorstellen, höflich reagieren, fragen und bestellen', progress: 0, state: 'active', lessons: 8 },
