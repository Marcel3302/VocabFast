...
if(!html.includes('v13-admin.css'))html=html.replace('</head>','  <link rel="stylesheet" href="v13-admin.css">\n  <link rel="stylesheet" href="v13-ui.css">\n</head>');
if(!html.includes('v13-ui.js'))html=html.replace('</body>','  <script src="v13-ui.js"></script>\n</body>');
if(!html.includes('v14-polish.css'))html=html.replace('</head>','  <link rel="stylesheet" href="v14-polish.css">\n</head>');
