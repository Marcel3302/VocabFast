...
const expected=['app.js','grammar-data.js','index.html','styles.css','level-index.js','ui-overrides.js','vocab-data.js'].sort();
...
if(wrangler.main!=='./src/worker-v3.js')throw new Error('Worker v3 main missing');
