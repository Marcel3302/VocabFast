...
if(wrangler.main!=='./src/worker-v6.js')throw new Error('Worker v6 main missing');
...
console.log(`Selftest OK: ${words.length} vocab (${c2} C2), ${grammar.length} grammar modules, V12 admin/PDF/Pro/practice/grammar verified.`);
